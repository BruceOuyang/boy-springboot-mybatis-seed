...
public class TableDao {
    ...
    public List<Column> getColumnList(String schema, String tableName) {
        ...
        try {
            String sql = "select column_name,data_type,column_comment, column_key, extra from information_schema.COLUMNS where TABLE_SCHEMA='" + schema + "' and table_name='" + tableName + "'";
            logger.info("excute sql {} ", sql);
